...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Run the fused transport's dispatch on aiter's FlyDSL TDM kernel instead of
    # mori's. Both carry the quantized wire's e8m0 row, so this is a straight
    # swap of the kernel that moves the payload; set to 0 to fall back to mori.
    # Only read on a quantizing wire under ATOM_MORI_V2_FUSED -- a bf16 wire
    # keeps whatever $MEGA_DISPATCH names.
